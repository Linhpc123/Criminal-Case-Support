...
function getNameProblemSolver() {
  nameps = document.querySelector("#nameps").value;
  document.querySelector("#nameps-value").innerHTML = nameps;
}

function getNameGuarantor() {
  nameg = document.querySelector("#nameg").value;
  document.querySelector("#nameg-value").innerHTML = nameg;
}
...
window.getNameProblemSolver = getNameProblemSolver;
window.getNameGuarantor = getNameGuarantor;
...
(["16", "17", "18", "19"].includes(item.id) || item.type === 1)
) return;
